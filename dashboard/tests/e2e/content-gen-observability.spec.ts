...
function makePipelineDetailResponse(): PipelineDetailResponse {
  const context: PipelineContext = {
    ...
    strategy: {
      ...
      content_pillars: [
        { name: "operator workflows", description: "", content_types: [] },
        { name: "AI systems", description: "", content_types: [] },
        { name: "launch analysis", description: "", content_types: [] },
      ],
      audience_segments: [],
      ...
      platform_rules: [],
      cta_strategy: { allowed_cta_types: [], default_by_content_goal: {} },
